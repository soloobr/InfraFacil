...
public class AdapterListViewPecas extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        ((TextView) view.findViewById(R.id.tvnome)).setText(item.getTexto());
        ((TextView) view.findViewById(R.id.tvqtdpeca)).setText(item.getQtd());
        ((TextView) view.findViewById(R.id.tvnumero)).setText(item.getNumero());
